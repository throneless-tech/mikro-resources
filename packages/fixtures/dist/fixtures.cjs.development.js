...
var classFixturesFactory = require('class-fixtures-factory');
var core = require('@mikro-orm/core');

var MetadataStore = /** @class */ (function (_super) {
    tslib.__extends(MetadataStore, _super);
    function MetadataStore(orm) {
        var _this = _super.call(this) || this;
        _this.orm = orm;
        _this.defaultStore = new classFixturesFactory.DefaultMetadataStore(true);
        return _this;
    }
    MetadataStore.prototype.make = function (classType) {
        var name = core.Utils.className(classType.name);
...
}(classFixturesFactory.BaseMetadataStore));

var FixtureFactory = /** @class */ (function () {
    function FixtureFactory(orm, options) {
        this.orm = orm;
        this.factory = new classFixturesFactory.FixtureFactory(options);
    ...
    FixtureFactory.prototype.registerAllEntities = function () {
        ...
        try {
            for (var entityNames_1 = tslib.__values(entityNames), entityNames_1_1 = entityNames_1.next(); !entityNames_1_1.done; entityNames_1_1 = entityNames_1.next()) {
    ...
    FixtureFactory.prototype.assigner = function (prop, obj, value) {
        ...
        if (Array.isArray(value) && obj[prop.name].add) {
            (_a = obj[prop.name]).add.apply(_a, tslib.__spread(value));
        }
        else {
            obj[prop.name] = value;
        }
    ...
    FixtureFactory.prototype.make = function (entityName) {
        ...
        return {
            ...
            one: baseResult.one,
            oneAndPersist: function () { return tslib.__awaiter(_this, void 0, void 0, function () {
                var entity;
            ...
            manyAndPersist: function (x) { return tslib.__awaiter(_this, void 0, void 0, function () {
                var entities;
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
...
//# sourceMappingURL=fixtures.cjs.development.js.map
